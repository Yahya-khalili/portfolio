  ...
  return (
    <div>
      <div className="home__data">
        <h1 className="home__title">Yahya Khalili
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Passionate about building scalable web applications and creating seamless user experiences. I specialize in both frontend and backend development, bringing ideas to life with modern technologies. Let's turn your vision into reality!</p>
